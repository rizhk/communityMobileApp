...
import { ChatIcon, GoBackButton } from "components/Button";
...
import { default as BgChat } from "./bgChat.png";
import { format } from "date-fns";
import { IconType } from "react-native-dynamic-vector-icons";

type Props = NativeStackScreenProps<DeepNavParam, "message">;

const NB_MESSAGES_PER_FETCH = 20;

export const MessageScreen: PelopsScreen = observer(({ navigation, route }: Props) => {
